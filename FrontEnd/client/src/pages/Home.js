                ...
                <Row>
                    <Col lg={{span: 9}}>
                        <div style={intro}>
                            ...
                            <p><EnvironmentOutlined /> Xóm 11 - Hải Trung - Hải Hậu - Nam Định</p>
                            <p><WhatsAppOutlined /> +(84) 975280221</p>
                            <p><MailOutlined /> huyhoangle789990@gmail.com</p>
                        </div>
                    </Col>
                    <Col lg={{span: 7}}>
                        <div style={intro}>
                            <h5 style={{color: '#fa8c16'}}>PAGE</h5>
                            <FacebookProvider appId="646768039528160">
                                <Page href="https://www.facebook.com/profile.php?id=61552441455928"/>
                            </FacebookProvider>
