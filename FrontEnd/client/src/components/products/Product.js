  ...
  return (
    <article className="product">
      <div className="img-container">
        <img
          src={product.images[0] ? product.images[0].urlImage : empty}
          alt="single product"
          height="240"
          width="auto"
        />
        ...
        <div onClick={handleClickAddToCart} className="btn-primary product-link">
          giỏ hàng
        </div>
      </div>
      <div className="product-info">
        <span>
          ...
          {product.viewCount >= 10 ? (
            ...
            <Tag style={{ marginLeft: 10 }} color="#389e0d">
              new
            </Tag>
          )}
        </span>
